...
def main():
    ...
    direction=int(input("What direction should be prioritised? 0:Up 1:Right 2:Down 3:Left \n Number:"))

    no_of_states=bfs(puzzle,goal,moves[direction])
